/*
  # Update groups data to match the UI

  1. New Data
    - Add demo groups that match what's shown in the UI
    - Set correct capacities, tutors, and academic years
    - Ensure proper relationships between groups and levels

  2. Structure
    - Create tables if they don't exist
    - Add demo data with proper IDs to match frontend
...
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'educational_levels' AND policyname = 'authenticated_users_can_read_levels') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'educational_levels' AND policyname = 'admins_can_insert_levels') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'educational_levels' AND policyname = 'admins_can_update_levels') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'educational_levels' AND policyname = 'admins_can_delete_levels') THEN
...
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'academic_groups' AND policyname = 'authenticated_users_can_read_groups') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'academic_groups' AND policyname = 'admins_can_insert_groups') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'academic_groups' AND policyname = 'admins_can_update_groups') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'academic_groups' AND policyname = 'admins_can_delete_groups') THEN
...
DO $$ 
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'student_group_assignments' AND policyname = 'authenticated_users_can_read_assignments') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'student_group_assignments' AND policyname = 'admins_can_insert_assignments') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'student_group_assignments' AND policyname = 'admins_can_update_assignments') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'student_group_assignments' AND policyname = 'admins_can_delete_assignments') THEN
